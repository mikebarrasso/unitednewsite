...
export const metadata: Metadata = createMetadata({
  title: "Our Services",
  description:
    "Explore our fee-only services: financial planning, retirement planning, investment management, tax planning, tax preparation, and equity compensation, all coordinated under one roof.",
  path: "/services",
});
