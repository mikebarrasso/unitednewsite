...
<p>We encourage you to <a href="/contact">contact United Financial Planning Group</a> for expert guidance from our team of CPAs and CFP\u00ae professionals. Our integrated approach to <a href="/services/tax-preparation">tax preparation</a> and financial planning ensures your financial journey is as successful as your business.</p>`,
  ...
  {
    slug: "three-questions-to-ask-before-you-retire",
    title: "3 Questions to Ask Before You Retire",
    date: "2026-07-28",
    category: "Retirement Planning",
    excerpt:
      "Before your last paycheck arrives, three questions deserve a clear answer: where will monthly income come from, how will you cover health care before Medicare kicks in, and which accounts should you draw from first to keep your tax bill manageable? A financial adviser from United Financial Planning Group walks through each one in a short video and explains why the answers need to be in your plan before you retire, not after.",
    author: "United Financial Planning Group",
    authorSlug: "firm",
    type: "blog",
    relatedServices: [
    ...
    faqs: [
      {
        question: "What are the main sources of retirement income for most retirees?",
        answer:
          "Most retirees draw income from a combination of Social Security benefits, tax-deferred retirement accounts such as traditional IRAs and 401(k)s, and personal savings or taxable investment accounts. The order in which you draw from each source, sometimes called your withdrawal sequence, can affect how long your assets last and how much you pay in taxes over time. Mapping out which account funds which expenses, and in what order, is one of the most practical steps you can take before leaving your last job.",
      },
      {
        question: "What should I do about health insurance if I retire before age 65?",
        answer:
          "Medicare eligibility begins at age 65. If you retire earlier, say at 62 or 63, you will need to bridge the coverage gap through another source. Common options include continuing your employer plan through COBRA (typically for up to 18 months), purchasing coverage through your state's health insurance marketplace, or joining a spouse's employer plan. The cost of that coverage can be substantial and should be included in your retirement budget from the start, not treated as a surprise expense.",
      },
      {
        question: "How does the order of retirement account withdrawals affect my taxes?",
        answer:
          "Different account types are taxed differently when you withdraw. Withdrawals from traditional IRAs and 401(k)s are generally taxed as ordinary income in the year you take them. Withdrawals from Roth accounts are generally tax-free for qualified distributions. Taxable brokerage account gains may be taxed at long-term capital gains rates, which are often lower than ordinary income rates. Drawing from accounts in a thoughtful sequence can help manage your annual taxable income, reduce the share of Social Security that becomes taxable, and limit exposure to Medicare premium surcharges. The right sequence depends on your specific accounts and income picture.",
      },
      {
        question: "When should I start planning for retirement income sourcing?",
        answer:
          "Ideally, the planning begins five to ten years before your target retirement date. That window gives you time to make decisions, such as adjusting contributions, considering Roth conversions, or setting aside reserves for health care costs, that are difficult or impossible to reverse once you have stopped working. Starting the conversation early expands your options; waiting until the last year narrows them.",
      },
      {
        question: "What does a fee-only fiduciary financial planner do differently in retirement planning?",
        answer:
          "A fee-only fiduciary is compensated only by client fees, not by commissions on products they recommend. As a fiduciary, they are legally required to act in your interest. In the context of retirement planning, this matters because the decisions around income sourcing, health care coverage, and tax sequencing are interconnected. A planner who also has in-house tax professionals, as United Financial Planning Group does with its team of CFP professionals, CPAs, and Enrolled Agents, can model how each decision affects the others rather than optimizing one piece in isolation.",
      },
    ],
    content: `<p>If you are five to ten years from retirement, you are likely focused on the number: how much do I need to save? That question matters. But three others tend to catch people off guard in the final stretch, and the time to answer them is while you still have room to adjust, not after you have already stopped working.</p>

<p>A financial adviser with <strong>United Financial Planning Group</strong> covers all three in the short video below. Each question is straightforward to state and takes more planning than most people expect to answer well. Watch the video first, then read on for a deeper look at each one.</p>

<div class="my-8 rounded-xl overflow-hidden aspect-video w-full bg-muted">
  <video
    controls
    preload="metadata"
    ...
    title="3 Questions to Ask Before You Retire"
  >
    <source src="https://nz2q9bvkofj2xcya.public.blob.vercel-storage.com/sites/fc1baa26-67fb-4bda-8df5-8a06ead90442/videos/united-retirement-questions-jP5JDuHIosSvklKCanwyyiQTXnAiKn.mp4" type="video/mp4" />
    <p>Your browser does not support the video element. Please <a href="/contact">contact us</a> to discuss your retirement planning questions directly.</p>
  </video>
</div>
...
<ul>
  <li><strong>Map your income before day one:</strong> Knowing which account pays which expense, and in what order, is one of the most valuable exercises you can do before retiring.</li>
  <li><strong>Medicare starts at 65, not at retirement:</strong> If you leave work before 65, health coverage is a budget line item that needs a plan, not an afterthought.</li>
  <li><strong>Account type determines tax treatment:</strong> Traditional retirement accounts, Roth accounts, and taxable savings all follow different tax rules on withdrawal, and the sequence you use can shift your tax picture meaningfully.</li>
  <li><strong>These conversations belong before retirement, not after:</strong> The decisions that affect income sourcing, health coverage, and tax sequencing are easier to adjust while you are still earning than once your paycheck has stopped.</li>
</ul>

<h2>Where Will Your Monthly Income Actually Come From? (00:00)</h2>

<p>For most of your career, the answer to this question was simple: your paycheck. In retirement, the answer gets more complicated and more consequential. Most retirees draw from a mix of Social Security, tax-deferred retirement accounts such as a traditional IRA or 401(k), and personal savings held in taxable accounts. Each source is different, and none of them arrive in the right amount automatically.</p>

<p>The planning work here involves more than adding up the balances. It means deciding which account funds ordinary monthly expenses, which covers larger one-time costs, and which gets left to grow as long as possible. It also means thinking through Social Security timing: claiming earlier produces a smaller monthly benefit for a longer period; delaying produces a larger benefit but requires bridging the gap with other assets. Neither choice is universally better. The right timing depends on your health, your spending needs, your other income sources, and your tax situation.</p>

<p>The adviser in the video calls this exercise mapping out which account pays for what and in which order, and describes it as one of the most useful planning steps available to anyone approaching retirement. That framing is accurate: the exercise forces you to put numbers to an abstract plan and often surfaces gaps or assumptions that need revisiting while there is still time to address them.</p>

<p>If you want to explore how <a href="/services/retirement-planning">retirement income planning</a> works in practice, our team works through exactly this kind of sequencing with clients who are approaching or already in retirement.</p>

<h2>What Is Your Plan for Health Care Before Medicare? (00:21)</h2>

<p>Medicare eligibility begins at 65. That fact sits quietly in the background of most retirement conversations, and then becomes urgent the moment someone decides to retire at 62 or 63.</p>

<p>The gap between your retirement date and your 65th birthday is a real budget exposure. Health insurance purchased through a marketplace or through an employer COBRA continuation plan costs significantly more than most people carry as an employer-sponsored premium. For a couple retiring at 62, that exposure can stretch across three years and add up to a substantial portion of their annual budget.</p>

<p>The planning implication, as the video addresses at around (00:21), is direct: if you are retiring before 65, the cost of health coverage belongs in your budget from day one. It should be modeled as a known expense, not handled as a surprise after the fact. That also means your income sequencing plan needs to account for it. If you need to draw additional income from retirement accounts to cover premiums, that withdrawal affects your taxable income, which in turn affects other parts of your plan including Medicare premium surcharges once you do reach 65.</p>

<p>This is the kind of interconnection that makes retirement planning genuinely complex: one decision affects another, and the effects can show up years later. A coordinated planning process, where financial planning and tax planning work together rather than in separate silos, is designed to catch these connections before they become problems.</p>

<h2>Which Accounts Should You Draw From First, and Why Does It Matter? (00:45)</h2>

<p>The order in which you draw from different account types in retirement can change your tax picture in ways that compound over time. Traditional IRA and 401(k) withdrawals are generally taxed as ordinary income in the year you take them. Qualified Roth IRA withdrawals are generally not taxed at all. Gains in a taxable brokerage account may be taxed at long-term capital gains rates, which are often lower than ordinary income rates for many retirees.</p>

<p>A thoughtful withdrawal sequence can help keep your annual taxable income at a level that avoids higher tax brackets, limits the share of your Social Security benefit that becomes taxable, and reduces exposure to Medicare Part B and Part D premium surcharges tied to income. Drawing down accounts in a less deliberate order can inadvertently push income into a higher bracket or trigger surcharges that were avoidable with some forethought.</p>

<p>The adviser makes this point clearly at (00:45): the order in which you draw from different accounts can change your overall tax picture, which is why it deserves a conversation before you retire, not after. That timing distinction matters. Once you are fully dependent on your portfolio for income, the flexibility to restructure your approach is more limited. Decisions made in the years leading up to retirement, including whether to do <a href="/blog/roth-conversion-strategy-pre-retirees">Roth conversions during a lower-income window</a>, can improve the long-term tax picture in ways that are difficult to replicate after the fact.</p>

<p>For a more detailed look at how bracket management and account sequencing fit into a broader pre-retirement strategy, the <a href="/blog/pre-retirement-tax-transition-managing-brackets-rmds">Pre-Retirement Tax Transition</a> article covers the mechanics in depth.</p>

<h2>If Any of These Questions Feel Unresolved, That Is Normal</h2>

<p>The adviser closes the video with a line worth repeating: if any of these questions feel unresolved, that is completely normal, and it is exactly what a planning conversation is for. That is not a soft landing on a hard topic. It is a practical acknowledgment that these questions are interconnected, and that resolving them well requires looking at your full picture, not each piece in isolation.</p>

<p>Income sourcing, health care coverage, and withdrawal sequencing are three separate planning problems that share the same inputs and affect each other's answers. Working through them together, with a team that handles both the financial planning and the tax work in one place, tends to produce a clearer and more durable plan than addressing them separately.</p>

<p>At <strong>United Financial Planning Group</strong>, our team of <strong>CFP&reg; professionals, CPAs, and Enrolled Agents</strong> works through these questions as a coordinated planning process. We are a <strong>fee-only fiduciary</strong> firm: our compensation comes only from our clients, not from products we recommend, so our planning is organized around what fits your situation.</p>

<p>If you are within ten years of retirement and would like a clear look at your income, health care, and tax picture, we invite you to <a href="/contact">schedule a complimentary conversation</a>. There is no obligation and no sales pitch: just a direct look at where your plan stands and what, if anything, deserves attention before you reach your retirement date.</p>

<h2 id="disclosures">Disclosures</h2>

<p>This article and the accompanying video are provided for general educational and informational purposes only. They do not constitute personalized financial, tax, investment, or legal advice and should not be relied upon as such. Individual circumstances vary. Results from any financial planning strategy depend on many factors specific to each person's situation. Please consult a qualified financial planner, CPA, or other professional regarding your specific circumstances before making any retirement planning decisions.</p>`,
  },
];
