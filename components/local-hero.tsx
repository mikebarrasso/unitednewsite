        ...
        >
          ...
          <div className="relative w-full h-full flex flex-col items-start lg:items-center justify-center pointer-events-auto px-4 lg:px-6">
            <motion.div
              ...
              className="flex items-center gap-2 pl-3 pr-4 py-1.5 bg-white rounded-full mb-6"
            >
            ...
            <motion.h1
              ...
              className="w-full text-4xl sm:text-5xl md:text-6xl font-medium font-serif text-white text-left lg:text-center leading-tighter tracking-tight max-w-4xl"
            >
              {headline}
            </motion.h1>
